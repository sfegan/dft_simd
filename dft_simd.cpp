/*
   ...
   fftw_simd/fftw_simd.cpp -- Stephen Fegan -- 2018-02-19
   ...
   This file is part of "fftw_simd"

   "fftw_simd" is free software: you can redistribute it and/or modify it
   under the terms of the GNU General Public License version 2 or
   later, as published by the Free Software Foundation.

   "fftw_simd" is distributed in the hope that it will be useful, but
